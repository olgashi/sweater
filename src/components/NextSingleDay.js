...
export default function NextSingleDay(props) {
  ...
  return (
    <Row className="single-day-weather">
      <Col md={3}>
        <Row className="next-day-weekday">{day}</Row>
      ...
      <Col md={3}>
        <Row className="next-day-low-high">High/Low:</Row>

        <Row className="next-day-low-high-temp">
          {Math.round(tempHigh)}/{Math.round(tempLow)}F
        </Row>
      ...
      <Col md={1}>
        ...
        <Row className="next-day-sunset">{sunset}</Row>
      </Col>
      ...
      <Col md={1}>
        ...
        <Row className="next-day-sunrise">{sunrise}</Row>
      </Col>
      <Col md={3}>
